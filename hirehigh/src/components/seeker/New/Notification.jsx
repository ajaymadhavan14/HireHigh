...
function Notifications() {
  return (
    ...
    >
      <Grid sx={{
        boxShadow: 3, m: 3, p: 1.9, width: '-webkit-fill-available', height: '50px', backgroundColor: 'lightgray', borderRadius: '10px', display: 'flex', justifyContent: 'center',
      }}
      >
        <NotificationsIcon />
      ...
      <Grid
        className="comp"
        sx={{
          boxShadow: 3, m: 3, p: 1, width: '-webkit-fill-available', height: '31.2vw', backgroundColor: 'lightgray', borderRadius: '10px', overflowY: 'scroll', overflowX: 'hidden',
        }}
      >
        <Box sx={{
          m: 1, p: 1, width: '-webkit-fill-available', backgroundColor: '#fff', borderRadius: '10px',
        }}
        >
